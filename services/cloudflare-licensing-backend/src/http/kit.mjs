...
// The canonical constant-time equality lives with the auth module (HMAC-over-a-one-time-key
// scheme, trusted by the backend and portal). Re-exported here so every worker uses the SAME
// implementation instead of a hand-rolled digest compare.
export { constantTimeEqual } from "../auth/account_auth.mjs";
