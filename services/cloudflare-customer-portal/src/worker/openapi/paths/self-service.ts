    ...
    ["/api/portal/checkout", {
      post: {
        ...
        responses: {
          ...
          "413": ERR_BODY_TOO_LARGE,
          "502": errorResponse("Backend was unreachable or its response was not valid JSON.", ["backend_unreachable", "backend_invalid_response"]),
          "503": errorResponse("BACKEND_ORIGIN is absent or invalid (backend_unconfigured), or account-token mint configuration is invalid (config_error).", ["backend_unconfigured", "config_error"]),
        },
      },
    }],
