...
export const BACKEND_PROXY_ERROR_MANIFEST = Object.freeze({
  checkout: freezeStatuses({
    ...
    "503": ["config_error", "seat_signing_unavailable", "verification_error"],
  }),
  ...
  release: freezeStatuses({
    ...
    "503": ["config_error", "verification_error"],
  }),
  download: freezeStatuses({
    ...
    "503": ["config_error", "lease_signing_unavailable", "verification_error"],
  }),
});
