...
import { generateAccountToken, hashToken } from "./primitives.mjs";
 ...
 *
 * @param {Record<string, unknown> & { _idOverride?: string }} options
 * @param {{ now?: number, pepperBytes?: Uint8Array, generated?: { raw: string, token_prefix: string } }} [dependencies]
 */
