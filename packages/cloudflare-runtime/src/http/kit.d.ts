// Hand-written types for the Worker-safe HTTP/security kit.

export declare function constantTimeEqual(a: unknown, b: unknown): Promise<boolean>;
export declare function safeErrorType(value: unknown): string;
...
export declare const HTML_NONCE_PLACEHOLDER: "__LICENSECC_HTML_NONCE__";
export declare function secureHtml(template: string, status?: number): Response;
