// D1 adapter for the portable tamper-evident audit-digest contract.
//
...
import { canonicalEntitlementEvent, computeSegmentDigest } from "@licensecc/licensing-domain/audit/audit_digest";
