 ...
 *
 * <p>Private keys are OpenSSL PKCS#1 PEM. Public keys are DER-encoded PKCS#1
 * RSA public keys. Signatures are in base64.</p>
 */
...
public:
	...
	virtual void generateKeyPair(std::size_t key_bits) {
		(void)key_bits;
		generateKeyPair();
	}
