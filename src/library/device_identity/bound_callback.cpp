...
const std::string& bound_callback_http_response(bool received) {
	static const auto build = [](bool success) {
		const std::string body =
			...
			"</title><style>:root{color-scheme:dark;font:16px/1.5 "
			"system-ui,sans-serif;background:#0f0f0f;color:#e8e8e8}body{margin:0;padding:48px "
			"20px}main{max-width:440px;margin:auto;padding:28px;background:#161616;border:1px solid "
			"#2a2a2a;border-radius:8px}h1{font-size:24px;margin:0 0 "
			"12px}p{color:#aaa;margin:0}</style><script>history.replaceState(null,'','/complete');</script><main><h1>" +
