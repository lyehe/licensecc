...
Integrate the project-specific runtime package, keep issuer keys out of the
customer build, and add host-owned hardening checks where the product needs
them. Local license checks improve enforcement and diagnostics, but they do not
make a customer-controlled machine tamper-proof.
