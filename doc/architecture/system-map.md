...
Current production-source totals are 19,358 lines for license-admin, 8,771 lines for licensing-backend, 6,480 lines for customer-portal, and 1,348 lines for D1-backup. These counts include tracked and non-ignored, untracked
