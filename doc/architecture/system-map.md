...
| `services/cloudflare-customer-portal/src/ui/features/devices/DevicesFeature.tsx` | 453 | Portal device/floating-seat workflow; portal-local state and consequences remain feature-owned. |
...
Current production-source totals are 19,358 lines for license-admin, 8,783 lines for licensing-backend, 6,552 lines for customer-portal, and 1,348 lines for D1-backup. These counts include tracked and non-ignored, untracked
